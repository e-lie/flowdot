...
## BuboBuboBubo Fork of FoxDot

### Goals

*  Adding a sync mechanism for Ableton Link.
*  Working on a featureful implementation of MIDI.
*  Making FoxDot usable along other live coding tools.
